...
// ✅ NEW: Navigate to edit store with proper data passing
  Future<void> _navigateToEditStore(StoreModel store) async {
    print('🔧 Navigating to edit store: ${store.name} (ID: ${store.id})');
// ✅ Clear any previous form data first
    _storeController.clearForm();

// ✅ Navigate with store data and wait for result
...
// ✅ If edit was successful, refresh the store list
    if (result == true) {
      print('✅ Store edit completed, refreshing list...');
      await _storeController.refreshStores();
    }
  }

// ✅ NEW: Navigate to add store
  Future<void> _navigateToAddStore() async {
    print('➕ Navigating to add new store');
// ✅ Clear form data for new store
    _storeController.clearForm();
...
// ✅ Navigate to add store screen
    final result = await Navigator.push<bool>(
      context,
      MaterialPageRoute(
        builder: (context) => AddNewStoreScreen(),
      ),
    );

// ✅ If add was successful, refresh the store list
    if (result == true) {
      print('✅ Store creation completed, refreshing list...');
      await _storeController.refreshStores();
    }
  }
        ...
        actions: [
          Padding(
            ...
            child: ElevatedButton(
              onPressed: _navigateToAddStore, // ✅ Updated to use new method
        ...
        child: Row(
          ...
          children: [
            IconButton(
              ...
              onPressed: () =>
                  _navigateToEditStore(store), // ✅ Updated to use new method
              tooltip: "Edit Store",
            ),
            IconButton(
                      ...
                      Expanded(
                        child: ElevatedButton.icon(
                          onPressed: () => _navigateToEditStore(
                              store), // ✅ Updated to use new method
